...
const FoodDetails = () => {
  ...
  <div className="p-4 max-w-7xl  bg-accent-d text-white mx-auto">
        ...
        <h1 className="text-4xl text-black font-bold mb-2">{foodItem.name}</h1>
        <p className="mb-2  ">Category: <span className="text-black cursor-pointer " >  {category} </span> </p>
        ...
        <button onClick={addToCart} className="bg-black text-white px-6 py-2 rounded hover:bg-black mb-6">
          Add to Cart
        </button>
        </div>
