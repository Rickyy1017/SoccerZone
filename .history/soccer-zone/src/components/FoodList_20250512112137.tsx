...
const FoodList: React.FC<FoodListItemProps> = ({ name, description, onClick, price}) => {
 
  return (
    <div className="flex justify-between border-b border-dashed border-[#006837] p-4 my-6">
      <div>
        <div onClick={() => console.log(object)} className="font-semibold text-[25px] capitalize py-[10px] cursor-pointer">
          {name}
        </div>
