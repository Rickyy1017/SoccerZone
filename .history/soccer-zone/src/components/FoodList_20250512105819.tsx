...
const [ handleDetails, setHandleDetails ] =
...
const FoodList: React.FC<FoodListItemProps> = ({ name, description, price }) => {
  return (
    <div className="flex justify-between border-b   border-dashed border-[#006837] p-4 my-6">
      <div>
        <div onClick={(handleDetails) => navigate(APP_ROUTES.HOME)} className="font-semibold text-[25px] capitalize py-[10px] cursor-pointer">{name}</div>
