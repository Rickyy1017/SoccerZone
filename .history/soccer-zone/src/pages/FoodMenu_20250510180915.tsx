...
const foodSections = [
  {
    ...
    items: [
      ...
      { name: "Quesa ", description: "Flour tortillas stuffed with your choice of chicken or shrimp, combined with bell peppers, onions, and a blend of cheeses, served with guacamole and sour cream.", price: 18800 },
