...
const Home = () => {
  ...
  return (
   <div className="bg-black max-w-xl mx-auto h-screen">
     <div
      className="p-4  bg-secondary-d flex flex-col items-center  "
    ...
    >
      ...
      <div>
        ...
        <p>Discover a delicious variety of food and drinks made with fresh ingredients just for you.
Check out our menus to find your next favorite dish or drink.</p>
      </div>
