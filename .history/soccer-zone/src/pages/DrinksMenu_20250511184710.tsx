...
const foodSections = [
  {
    ...
    items: [
      ...
      { name: "Garden ", description: "A vibrant combination of yam fingers, fried plantain, chicken suya, peppered chicken wings, peppered snails, and peppered gizzards, served with a tangy chili red sauce for dipping.", price: 28200 },
    ], 
  }, 
  {
