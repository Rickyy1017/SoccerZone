...
const foodSections = [
  ...
  items: [
    ...
    { name: " Burger", description: "A juicy, grilled Premium Angus beef patty topped with cheddar cheese, caramelized onions, crispy beef bacon, iceberg lettuce, tomato, pickles, and a signature cocktail sauce", price: 21000 },
  ],
},
