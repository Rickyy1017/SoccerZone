...
const foodSections = [
  {
    ...
    items: [
      ...
      { name: "Mini Beef Burger", description: "A smaller version of our Classic Burger, featuring grilled Premium Angus beef, cheddar cheese, grilled onions, sautéed mushrooms, tomato, iceberg lettuce, pickles, and cocktail sauce.", price: 849 },
