...
const foodSections = [
  ...
  items: [
    { name: "tiki garden", description: "A classic favorite, featuring crisp lettuce tossed in a rich Caesar dressing, topped with tender grilled chicken breast, crispy beef bacon, golden croutons, and freshly grated parmesan cheese.", price: 15800 },
