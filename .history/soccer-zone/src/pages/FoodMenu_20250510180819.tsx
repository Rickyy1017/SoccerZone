...
const foodSections = [
  {
    ...
    items: [
      ...
      { name: "Chicken C", description: "Taco bread generously stuffed with a savory mixture of chicken, red and green bell peppers and topped with crispy onion", price: 13200 },
