...
const foodSections = [
  ...
  items: [
    ...
    { name: "Seafood Salad", description: "A refreshing blend of mixed greens and boiled potato cubes, accompanied by crab stick, tender calamari,baby octopus and baby prawns. Special seafood dressing.", price: 8400 },
