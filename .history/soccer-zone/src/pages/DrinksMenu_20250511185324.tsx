...
const foodSections = [
  ...
  items: [
    { name: "tiki garden", description: "Gin base cocktail with aperol, passion fruit, fluffy pineaple and lemon juice.", price: 15800 },
    { name: "", description: "Gin base cocktail with aperol, passion fruit, fluffy pineaple and lemon juice.", price: 15800 },
  ],
},
  {
  title: "cocktails",
