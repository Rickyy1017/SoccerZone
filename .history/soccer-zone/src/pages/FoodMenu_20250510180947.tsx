...
const foodSections = [
  {
    ...
    items: [
      ...
      { name: "Seafood Combo", description: "A delightful assortment of fried calamari, shrimp spring rolls, shrimp suya skewers, grouper sticks and salmon cake.", price: 549 },
