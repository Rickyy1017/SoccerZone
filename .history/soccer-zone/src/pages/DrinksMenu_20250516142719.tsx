...
},
{
  title: "mocktails",
  items: [
    { name: "chapman", description: "Orange juice, lemon juice with sprite and fanta, topped with angostura bitters.", price: 10100 },
    { name: "green fizz", description: "Mint leaves with a twist of cucumber juice, lemon juice, simple syrup and sprite.", price: 10100 },
    
    { name: "fruity ", description: "Vanilla and peach syrup, with apple juice, fresh blueberry and orange blossom water.", price: 10100 },
    { name: "", description: "", price: 10100 },
    { name: "", description: "", price: 10100 },
    { name: "", description: "", price: 10100 },
  ]
}
...
const DrinksMenu = () => {
  ...
  return (
   <div className="bg-secondary-d bg-secondary-d " style={{ backgroundImage: `url(${Bg})` }}>
     <Layout
      navbar={
        <Navbar
    ...
    >
      ...
      <div className="p-[10px] bg-secondary my-[50px]  bg-[#fcedda18] m-auto space-y-12 rounded-2xl ">
            ...
            <div className="flex flex-col gap-6">
              {section.items.map((item) => (
                <DrinkList
                  ...
                  price={item.price}
                  details={(name: string) => navigate(APP_ROUTES.DETAILS.replace(":name", encodeURIComponent(name)))}
                />
              ))}
            </div>
          </section>
