...
const FoodMenu = () => {
  ...
  return (
   <div className="bg-black flex text-center">
     <Layout
      navbar={
        <Navbar
    ...
    >
      <div>
        <h1 className=" font-semibold text-primary flex items-center text-center ">Food Menu</h1>
      </div>
      <div className="p-[40px] bg-secondary w-[90%] m-auto space-y-12">
