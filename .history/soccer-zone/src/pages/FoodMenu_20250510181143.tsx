...
const foodSections = [
  {
    ...
    items: [
      ...
      { name: "Trufle Salad", description: "Your choice of beef, chicken, or shrimp, marinated in suya spices and grilled, served with fresh tomato and onion.", price: 14200 },
