...
const foodSections = [
  ...
  title: "Salads",
  items: [
    { name: "Chiken Caesar Salad", description: "A classic favorite, featuring crisp lettuce tossed in a rich Caesar dressing, topped with tender grilled chicken breast, crispy beef bacon, golden croutons, and freshly grated parmesan cheese.
