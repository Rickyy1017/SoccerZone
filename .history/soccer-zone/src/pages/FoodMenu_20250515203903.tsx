...
const FoodMenu = () => {
  ...
  return (
    <div className="bg-secondary-d  w-[100%] border-red-500 " style={{ backgroundImage: `url(${Bg})` }}>
      <Layout
        navbar={
          <Navbar
      ...
      >
        ...
        <div className="p-[10px] bg-secondary my-[50px] border bg-[#fcedda] m-auto space-y-12 rounded-2xl ">
